...
class Barang_m extends CI_Model
{
    ...
    {
        $sql = "SELECT a.id_barang, a.keterangan, a.gambar, a.kode_barang, a.barcode ,a.nama_barang, b.satuan, c.kategori, a.harga_beli, 
    ...
    public function Save()
    {
        ...
        $data = array(
            ...
            'gambar'           => htmlspecialchars(!$this->upload->do_upload('gambar') ? 'default.png' : $this->upload->data('file_name'), true),
    ...
    {
        $sql = "SELECT a.gambar, a.harga_beli, a.keterangan,a.id_barang, a.kode_barang, d.nama_supplier, a.barcode ,a.nama_barang, b.satuan, c.kategori,
        a.stok FROM barang a LEFT JOIN satuan b ON b.id_satuan = a.id_satuan LEFT JOIN kategori c ON c.id_kategori = a.id_kategori LEFT JOIN supplier d ON d.id_supplier = a.id_supplier WHERE a.is_active = 1 AND a.stok < 20 ORDER BY a.stok ASC";
        return $this->db->query($sql)->result_array();
    }
}
