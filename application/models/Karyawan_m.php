...
class Karyawan_m extends CI_Model
{
    ...
    {
        // Join between karyawan and jabatan
        $this->db->select('karyawan.*, jabatan.nama_jabatan');
    ...
    {
        $date = date('Y-m-d');
        $sql = "SELECT a.id_karyawan, a.nama_karyawan, SUM(b.komisi) as total FROM karyawan a, komisi b WHERE a.id_karyawan = b.id_karyawan AND SUBSTRING(b.tanggal, 1, 10) =  '$date' GROUP BY a.id_karyawan ORDER BY total DESC";
