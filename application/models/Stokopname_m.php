...
class Stokopname_m extends CI_Model
{
  ...
  {
    $sql = "SELECT a.id_stok_opname, b.kode_barang, b.barcode, b.nama_barang, a.stok, a.stok_nyata, a.selisih, a.keterangan, a.tanggal, a.nilai FROM stok_opname a, barang b WHERE a.id_barang = b.id_barang";
