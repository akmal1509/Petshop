                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form class="form-horizontal" method="post" action="<?php echo base_url('report/prestasi') ?>">
                            ...
                            <p style="margin-left: 9px"><i>Perhatian: Fitur ini berfungsi untuk mengetahui prestasi karyawan dan perolehan komisi karyawan per periode tanggal yang anda tentukan.</i> </p>
                            <div class="form-group">
