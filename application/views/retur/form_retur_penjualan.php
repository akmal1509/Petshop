    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Buat Retur Penjualan</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <form action="<?= base_url('retur/simpan_retur_penjualan') ?>" method="post" id="formSubmit">
                            <section class="content invoice">
                                <?php if (isset($penjualan)) : ?>
                                    <input type="hidden" name="id_penjualan" class="form-control" value="<?= $penjualan->id_jual ?>">
                                    <input type="hidden" name="invoice" class="form-control" value="<?= $penjualan->invoice ?>">
                                    <div class="row" style="margin-bottom: 40px;">
                                        <div class="invoice-header">
                                            <h3>
                                                Total Penjualan
                                                <strong class="pull-right">Rp. <?= number_format($penjualan->subtotal) ?></strong>
                                            </h3>
                                        </div>
                                        <small> Note : Total diatas termasuk transaksi servis / jasa</small>
                                    </div>
                                    ...
                                    <div class="row invoice-info" style="margin-bottom: 30px;">
                                        <div class="col-sm-4 invoice-col">
                                            Pelanggan :
                                            <address>
                                                <strong><?= $penjualan->nama_cs ?></strong>
                                                <br><?= $penjualan->jenis_cs ?>
                                            </address>
                                        </div>
                                        ...
                                        <div class="col-sm-4 invoice-col">
                                            Kasir :
                                            <address>
                                                <strong><?= $penjualan->nama_lengkap ?></strong>
                                                <br>Telp: <?= $penjualan->telp_user ?>
                                                <br>Email: <?= $penjualan->email_user ?>
                                            </address>
                                        </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($detil as $item) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $item->qty_jual ?></td>
                                                            <td>
                                                                <input type="hidden" class="form-control" value="<?= $item->harga_item ?>" name="harga_item[]" id="harga_item_<?= $no - 1 ?>">
                                                                <input type="hidden" class="form-control" value="<?= $item->id_barang ?>" name="id_barang[]">
                                                                <input type="hidden" class="form-control" value="<?= $item->id_detil_jual ?>" name="id_detil_jual[]">
                                                                <select name="jumlah_retur[]" id="jumlah_retur" class="form-control jumlah_retur">
                                                                    <?php for ($i = 0; $i <= $item->qty_jual; $i++) : ?>
                                        ...
                                        <div class="col-md-4 pull-right">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <tbody>
                                                        <tr>
                                                            <th style="width:70%">Total Penjualan :</th>
                                    ...
                                    <div class="row no-print">
                                        <div class=" ">
                                            ...
                                            <a href="<?= base_url('retur/penjualan') ?>" class="btn btn-danger pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Cancel</a>
                                        </div>
                                    </div>
                        </form>
                    <?php else : ?>
