							...
							<tbody>
								<?php foreach ($retur as $key => $item) : ?>
									<tr>
										...
										<td><?= $item->catatan ?></td>
										<td>
											<a href="#" class="btn btn-success btn-xs detail-retur-beli" data-id="<?= $item->id_retur_pembelian ?>"><i class="fa fa-search"></i></a>
											<a href="#" class="btn btn-success btn-xs" title="Print Resi" onclick="cetakResi('<?= $item->id_retur_pembelian ?>')"><i class="fa fa-print"></i></a>
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
...
<?php include 'detail_retur_pembelian.php'; ?>
