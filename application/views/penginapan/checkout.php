 	...
 	<div class="modal-dialog">
 		<div class="modal-content">
 			...
 			<div class="modal-body">
 				<form class="form-horizontal" method="post" action="<?php echo base_url('penginapan/simpanpenjualan') ?>">
 					<div class="form-group">
 						...
 						<input type="hidden" class="form-control" name="antar" id="antar" readonly>
 						<input type="hidden" class="form-control" name="biaya" id="biaya" readonly>
 						<input type="hidden" class="form-control" name="nama_konsumen" id="nama_konsumen" readonly>
 						<input type="hidden" class="form-control" name="status_makanan" id="status_makanan_m" readonly>
 						<input type="hidden" class="form-control" name="deskripsi" id="deskripsi_m" readonly>
 						<input type="hidden" class="form-control" name="telp_konsumen" id="telp_konsumen" readonly>
 						<input type="hidden" class="form-control" name="alamat_konsumen" id="alamat_konsumen" readonly>
 						...
 						<div class="col-md-6 col-sm-6 col-xs-12">
 							<div class="checkbox">
 								...
 								<?php if (infoLogin()['tipe'] != 'Kasir') { ?>
 									<label>
 										<input type="radio" name="metode" id="kredit" value="credit"> Kredit
 									</label>
 								<?php } ?>
 								<label>
