		 						...
		 						<div class="x_content">
		 							...
		 							<div class="form-group">
		 								...
		 								<div class="col-md-9 col-sm-9 col-xs-12">
		 									...
		 									<input type="text" id="jenis" value="Produk" readonly name="jenis" class="form-control" required>
		 								</div>
		 							</div>
		 						</div>
		 					</div>
		 					...
		 					<div class="x_panel">
		 						...
		 						<div class="x_content">
		 							...
		 							<div class="form-group barcode-produk">
		 								...
		 								<label class="control-label col-md-3 col-sm-3 col-xs-12" style="margin-right:9px">Kode Barang</label>
		 								<div class="input-group">
		 									<!-- <input type="text" class="form-control" name="barcode" id="barcode" autofocus autocomplete="off" onkeypress="scanBarcode()"> -->
		 									<select id="barcode" name="barcode" class="form-control select2" required data-placeholder="Pilih Barang">
