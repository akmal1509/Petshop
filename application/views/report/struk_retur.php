...
<body>
	...
	<table class="" style="width:100% ;">
		<tr>
			<th class="text-right" style="width:75%">PPN</th>
			<th class="text-right"><?= 0 ?></th>
		</tr>
		<tr>
			<td class="text-right bold" style="width:75%">DPP</th>
			<td class="text-right bold" style="border-bottom: 1px solid black;"><?= $item->subtotal ?></th>
		</tr>
		<tr>
			<td class="text-right bold" style="width:75%">Total</th>
			<td class="text-right bold"><?= $item->subtotal ?></th>
		</tr>
	</table>
</body>
