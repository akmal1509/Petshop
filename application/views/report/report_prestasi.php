...
$sql_prestasi = "SELECT a.id_karyawan, a.nama_karyawan, a.kode_karyawan, SUM(b.komisi) as total FROM karyawan a, komisi b WHERE a.id_karyawan = b.id_karyawan AND SUBSTRING(b.tanggal, 1, 10) BETWEEN '$awal' AND '$akhir' GROUP BY a.id_karyawan ORDER BY total DESC";
