<div class="modal fade" id="inputKasModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="inputKasModal">Entry Data Kas</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" method="post" action="<?php echo base_url('kas/input') ?>">
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<select id="jenis" name="jenis" class="form-control" required>
								...
								<!-- <option value="Mutasi Ke Bank">Mutasi Ke Bank</option> -->
							</select>
						</div>
					</div>
					<div class="form-group">
