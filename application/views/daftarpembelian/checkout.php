    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?php echo base_url('pembelian/updatepembelian') ?>">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="id_beli" id="id_beli" readonly>
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                <input type="text" class="form-control" name="subtotal" id="subtotal" readonly>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Bayar (yang sudah dibayarkan)</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="number" class="form-control" name="bayar" id="bayar" autocomplete="off" value="<?= $pembelian['0']['bayar']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label mb-1 col-md-3 col-sm-3 col-xs-12">Status</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="checkbox">
                                <label>
                                    <input type="radio" name="status" id="draft" value="0" <?php if ($pembelian["0"]["status"] == 0) : ?> checked <?php endif; ?>> Draft
                                </label>
                                <label>
                                    <input type="radio" name="status" id="post" value="1" <?php if ($pembelian["0"]["status"] == 1) : ?> checked <?php endif; ?>> Post
                                </label>
                            </div>
                        </div>
                    </div>
