		 					...
		 					<div class="x_panel">
		 						...
		 						<div class="x_content">
		 							...
		 							<div class="form-group">
		 								...
		 								<div class="col-md-9 col-sm-9 col-xs-12">
		 									<select id="customer_type" name="customer_type" class="form-control select2" required>
		 							...
		 							<div class="form-group">
		 								...
		 								<div class="col-md-9 col-sm-9 col-xs-12">
		 									<!-- <select id="jenis" onchange="selectJenis()" name="jenis" class="form-control select2" required>
		 										...
		 										<option value="Servis">Jasa</option>
		 									</select> -->
		 									<input type="text" class="form-control" id="jenis" name="jenis" required readonly value="Servis">
		 								</div>
		 							</div>
		 							<div class="form-group">
		 								<label class="control-label col-md-3 col-sm-3 col-xs-12">Deskripsi</label>
		 								<div class="col-md-9 col-sm-9 col-xs-12">
		 									<textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="5" placeholder="Request customer atau informasi lainnya"></textarea>
		 								</div>
		 							</div>
		 						</div>
		 					</div>
		 					...
		 					<div class="x_panel">
		 						...
		 						<div class="x_content">
		 							...
		 							<div class="form-group">
		 								...
		 								<label class="control-label col-md-3 col-sm-3 col-xs-12" style="margin-right:9px">Jasa</label>
		 								<div class="input-group">
		 									<!-- <input type="text" class="form-control" name="kode_servis" id="kode_servis" autofocus autocomplete="off"> -->
		 									<select id="kode_servis" name="kode_servis" class="form-control select2" required data-placeholder="Pilih Servis">
		 										<option value="0" disabled selected>Pilih Servis</option>
		 										<?php foreach ($servis as $servis) : ?>
		 											<option value="<?php echo $servis['id_servis'] ?>"><?php echo $servis['nama_servis'] ?></option>
		 										<?php endforeach; ?>
		 									</select>
		 									<span class="input-group-btn">
